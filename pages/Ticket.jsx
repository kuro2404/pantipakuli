...
//   }, [numberBets])
  ...
  return (
    <div className=' ml-[20px] mt-[10px] w-[196px] font-bold border-black border-2'>
      <h1>Panti Pakhuli</h1>
      <h1>Game Made For Entertainment Purposes Only</h1>
      {/* <h1 className='font-bold'>Agent: {auth.user.userName}</h1> */}
      <h1 className='font-bold'>Game Name: Panti Pakhuli</h1>
